...
df['Country/Region'] = df['Country/Region'].replace('Congo (Kinshasa)', "Congo")
df['Country/Region'] = df['Country/Region'].replace("Cote d'Ivoire", "Côte d'Ivoire")
...
df['Country/Region'] = df['Country/Region'].replace('St. Martin', 'Saint Martin')
